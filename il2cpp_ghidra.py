...
class ScriptContext:
	...
	def process(self):
		...
		try:
			...
			metadata_path = os.path.join(self._backend.get_script_directory(), "./il2cpp_ghidra.json")
...
class GhidraDisassemblerInterface(BaseDisassemblerInterface):
	...
	def on_start(self):
		...
		if len(getDataTypes('Il2CppObject')) == 0:
			print('STOP! You must import the generated C header file (./il2cpp_ghidra.h) before running this script.')
